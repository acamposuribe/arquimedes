...
def global_bridge_prompt(schema: str, packet_path: Path, memory_path: Path, domain: str) -> tuple[str, str]:
    system = (
        ...
        "- Prefiere reenfocar un puente existente con links_to_existing cuando su título, descriptor, alias o síntesis puedan ajustarse honestamente para incluir los clusters pendientes.\n"
